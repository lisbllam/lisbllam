...
* Nombre: Lisbeth Llamuca
* Ocupación: Estudiante de Ingenieria en Ciencias de la Computación, ESPOL
* Lugar de residencia: Ecuador
## Proyectos
* [Gestionador de reservas de lugares de una institución](https://github.com/anzagood1/Proyecto-Segundo-Parcial-POO.git): Sistema que gestiona reservas de aulas, laboratorios, etc, con diferentes tipos de usuarios como profesor, estudiante u otro. Lenguaje 100% Java.
